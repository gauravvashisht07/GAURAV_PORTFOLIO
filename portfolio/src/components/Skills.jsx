    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="w-20 h-1 bg-linear-to-r from-purple-600 to-blue-600 mx-auto rounded-full" />
        </motion.div>
...
const SkillCard = ({ title, skills, icons = false, delay = 0 }) => {
  return (
    <motion.div
      ...
      className="p-8 rounded-2xl bg-gray-800 shadow-lg border border-gray-700 hover:border-purple-600 transition-all"
    >
      <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
        <span className="w-1 h-8 bg-linear-to-b from-purple-600 to-blue-600 rounded-full mr-3" />
        {title}
      </h3>
      ...
      <ul className="space-y-3">
        {skills.map((skill, index) =>
          icons ? (
            ...
            >
              <span className="text-2xl text-purple-400 shrink-0">
                {skill.icon}
              </span>
