...
const Testimonials = () => {
 const testimonials = [
  ...
  return (
    <section className="py-20 px-6 bg-linear-to-br from-gray-900 via-gray-800 to-gray-800 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="w-20 h-1 bg-linear-to-r from-purple-600 to-blue-600 mx-auto rounded-full mt-6" />
        </motion.div>
...
const TestimonialCard = ({ testimonial, index }) => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-linear-to-br from-purple-500/10 to-blue-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-all blur" />

      <div className="relative p-8 rounded-2xl bg-gray-800 border border-gray-700 shadow-lg group-hover:shadow-xl group-hover:border-purple-600 transition-all h-full flex flex-col">
        {/* Quote icon */}
        <motion.div
          initial={{ rotate: -10, opacity: 0 }}
          whileInView={{ rotate: 0, opacity: 1 }}
          transition={{ delay: index * 0.1 + 0.2 }}
          className="text-3xl text-purple-400/30 mb-4"
        >
          <FaQuoteLeft />
        </motion.div>
