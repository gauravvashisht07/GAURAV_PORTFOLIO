...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-20 px-6 bg-linear-to-br from-gray-800 via-gray-900 to-gray-800 relative overflow-hidden"
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gray-800 rounded-2xl p-8 md:p-12 shadow-lg border border-gray-700 mb-8"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {highlights.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -8 }}
              className="bg-gray-800 rounded-xl p-6 shadow-md border border-gray-700 hover:shadow-lg hover:border-blue-600 transition-all"
            >
