      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center">
        ...
        <div className="grid gap-6 sm:grid-cols-3 mb-12">
          {contactLinks.map((link, index) => (
            ...
            >
              {/* Background gradient */}
              <div className={`absolute inset-0 bg-linear-to-br ${link.color} ${link.hoverColor} transition-all duration-300 opacity-0 group-hover:opacity-5`} />
              
              {/* Card content */}
              <div className="relative p-8 rounded-2xl bg-gray-800 shadow-lg border border-gray-700 group-hover:border-blue-600 transition-all">
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 10 }}
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-linear-to-br ${link.color} text-white text-2xl mx-auto mb-4 transition-all`}
                >
                  {link.icon}
                </motion.div>

                <p className="font-bold text-white text-lg mb-2 group-hover:text-blue-400 transition">
                  {link.label}
                </p>
                ...
                <div className="flex items-center justify-center gap-2 text-blue-400 font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                  <span>Reach out</span>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 rounded-lg bg-linear-to-r from-blue-600 to-blue-700 text-white font-semibold hover:shadow-lg transition-all"
          >
